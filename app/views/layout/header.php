...
<body>
    <div class="head">
        <div class="logo">
            <a href="\dse\C-W\Advertising-Website\app\views\ads\view_ads.php"><img src="\dse\C-W\Advertising-Website\public\assets\images\BuySelLogo.png" alt="Home"
                    class="home-icon"></a>
        </div>
        <div class="name">
            <a href="\dse\C-W\Advertising-Website\app\views\ads\view_ads.php"><h1>BuySel.lk</h1></a>
        </div>
        <div class="nav">
